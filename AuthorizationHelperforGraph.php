...
class AuthorizationHelperForAADGraphService
{
    ...
    public static function getAuthenticationHeader($appTenantDomainName, $appPrincipalId, $password){
        ...
        // FIXME: Change the resource to the SP site
        //$graphId = 'https://patsoldemo.sharepoint.com';
        $protectedResourceHostName = 'graph.windows.net';
        // FIXME: Change the resource host name to the patsoldemo site
        //$protectedResourceHostName = 'patsoldemo.sharepoint.com';
        ...
        // FIXME: Change the token service location to the common service
